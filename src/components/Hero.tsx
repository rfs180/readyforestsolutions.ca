      ...
      <div className="relative z-20 h-full flex items-center justify-center text-center px-4">
        <div className="max-w-4xl">
          ...
          <h1 className="font-typewriter text-4xl md:text-6xl font-bold text-gold mb-6">
            Precision Tree Removal in Edmonton & St. Albert
          </h1>
          ...
          <button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-lg text-lg font-semibold inline-flex items-center gap-2 transition-colors font-typewriter">
